...
<div class="grid gap-5 grid-cols-1 sm:grid-cols-2 my-5">
    <template v-if="data.customer.shipping_address?.default_billing || !data.customer.shipping_address || !data.customer.billing_address">
        ...
        <a href="/account/address/new" class="h-full min-h-[180px] flex flex-col items-center justify-center gap-y-2 font-medium bg-ct-border rounded max-sm:hidden">
            <span>+</span>
