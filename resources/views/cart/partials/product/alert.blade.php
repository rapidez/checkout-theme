<div
    class="flex self-start items-center rounded-sm gap-x-1 font-medium text-primary border border-yellow-300 bg-yellow-100 text-xs w-fit max-xl:absolute max-xl:top-2 max-xl:right-0 py-0.5"
